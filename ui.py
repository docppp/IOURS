...
Regen	26.00%""")
        ...
        self.spinbox1 = ttk.Spinbox(self.Runesframe)
        ...
        self.spinbox2 = ttk.Spinbox(self.Runesframe)
        ...
        self.spinbox3 = ttk.Spinbox(self.Runesframe)
        ...
        self.spinbox4 = ttk.Spinbox(self.Runesframe)
        ...
        self.spinbox6 = ttk.Spinbox(self.Opponentframe)
