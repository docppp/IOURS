...
for r in range(0, 74):
    ...
    #  During Attack
    if middle_ship_stats['number'] == target_ship[-1] and attacking_ship[-1] == 4:
    ...
    if middle_ship_stats['number'] == attacking_ship[-1] and target_ship[-1] == 4:
    ...
    if left_ship_stats['number'] == target_ship[-1] and attacking_ship[-1] == ai_ship_stats['number']:
    ...
    if left_ship_stats['number'] == attacking_ship[-1] and target_ship[-1] == ai_ship_stats['number']:
    ...
    if right_ship_stats['number'] == target_ship[-1] and attacking_ship[-1] == ai_ship_stats['number']:
    ...
    if right_ship_stats['number'] == attacking_ship[-1] and target_ship[-1] == ai_ship_stats['number']:
